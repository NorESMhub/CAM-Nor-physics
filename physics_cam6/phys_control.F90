...
subroutine phys_ctl_readnl(nlfile)
   ...
   namelist /phys_ctl_nl/ cam_physpkg, use_simple_phys, cam_chempkg, waccmx_opt,  &
      ...
      offline_driver, convproc_do_aer, dme_energy_adjust, &
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, microp_scheme_out, &
                        ...
                        offline_driver_out, convproc_do_aer_out, dme_energy_adjust_out, &
                        cam_snapshot_before_num_out, cam_snapshot_after_num_out, &
                        cam_take_snapshot_before_out, cam_take_snapshot_after_out, physics_grid_out) !+tht
!-----------------------------------------------------------------------
