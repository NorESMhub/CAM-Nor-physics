...
character(128),   intent(out) :: errstring       ! Output status (non-blank for error return)
!AL
real(r8), intent(out), optional :: nnuccco(pcols,pver)   ! immersion freezing
real(r8), intent(out), optional :: nnuccto(pcols,pver)   ! contact freezing
real(r8), intent(out), optional :: npsacwso(pcols,pver)  ! accr. snow
real(r8), intent(out), optional :: nsubco(pcols,pver)    ! evaporation of droplet 
real(r8), intent(out), optional :: nprao(pcols,pver)     ! accretion
real(r8), intent(out), optional :: nprc1o(pcols,pver)    ! autoconversion
real(r8), intent(out), optional :: nqcsedten(pcols,pver) ! nqc sedimentation tendency
real(r8), intent(out), optional :: nqisedten(pcols,pver) ! nqc sedimentation tendency
real(r8), intent(out), optional :: nmelto(pcols,pver)    ! melting of cloud ice
real(r8), intent(out), optional :: nhomoo(pcols,pver)    ! homogeneos freezign cloud water
real(r8), intent(out), optional :: nimelto(pcols,pver)   ! melting of cloud ice
real(r8), intent(out), optional :: nihomoo(pcols,pver)   ! homogeneos freezign cloud water
real(r8), intent(out), optional :: nsacwio(pcols,pver)   ! numb conc tend due to HM ice multiplication
real(r8), intent(out), optional :: nsubio(pcols,pver)    ! evaporation of cloud ice number (sublimation?)
real(r8), intent(out), optional :: nprcio(pcols,pver)    ! numb conc tend due to auto of cloud ice to snow
real(r8), intent(out), optional :: npraio(pcols,pver)    ! numb conc tend due to accr of cloud ice by snow
real(r8), intent(out), optional :: nnudepo(pcols,pver)   ! deposition?
real(r8), intent(out), optional :: npccno(pcols,pver)    ! activation
real(r8), intent(out), optional :: nnuccdo(pcols,pver)   ! ni nucleation
real(r8), intent(out), optional :: mnudepo(pcols,pver)   ! deposition (mass)
real(r8), intent(out), optional :: nctncons(pcols,pver)  ! nc tuning to conserve number in substeps
real(r8), intent(out), optional :: nctnnbmn(pcols,pver)  ! nc tuning: minimum droplet number
real(r8), intent(out), optional :: nctnszmn(pcols,pver)  ! nc tuning: minimum slope
real(r8), intent(out), optional :: nctnszmx(pcols,pver)  ! nc tuning: maximum slope
real(r8), intent(out), optional :: nctnncld(pcols,pver)  ! nc tuning: removal of nc when qc is zero after mg
real(r8), intent(out), optional :: nitncons(pcols,pver)  ! ni tuning to conserve number in substeps
real(r8), intent(out), optional :: nitnszmn(pcols,pver)  ! ni tuning: minimum slope
real(r8), intent(out), optional :: nitnszmx(pcols,pver)  ! ni tuning: maximum slope
real(r8), intent(out), optional :: nitnncld(pcols,pver)  ! ni tuning: removal of ni when qi is zero after mg
!AL
