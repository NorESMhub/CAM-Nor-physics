...
!+tht taper
   logical  :: am_fix_taper  ! taper global AM fixer at high altitude
   real(r8) :: am_fix_tpr_h  ! start taper of global AM fixer (pressure altitude)
   real(r8) :: am_fix_tpr_w  ! width of taper function for global AM fixer (pressure interval)
!-tht
